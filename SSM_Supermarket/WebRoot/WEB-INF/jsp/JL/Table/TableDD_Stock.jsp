                            ...
                            <div class="body-nest" id="Filtering1">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<button type="button" onclick="js_x_stock('${s.stockID }')" class="btn btn-primary btn-xs">修改</button>
                                        	<button type="button" onclick="js_x_xd('${s.stockID }')" class="btn btn-primary btn-xs">下单</button>
